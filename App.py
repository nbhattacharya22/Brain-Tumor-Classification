...
if 'predicted_class' in st.session_state: # If the prediction has been made, display the prediction
    st.markdown("<h4 style='text-align: center;'>Based off the X-ray image uploaded: <b>{st.session_state['predicted_class']}</b></h4>", unsafe_allow_html=True) # Display the prediction on the app
